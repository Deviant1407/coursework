...
<head>
  <meta charset="utf-8" />
  <title>Личный кабинет куратора: аккаунт</title>
...
<body>
	<div class="bg bg_2 bg_dark">
		...
		<div class="main right main_dark">
			<div class="main_window left">
				...
				<div class="window_1 bg_color_1_dark">
					...
					<div class="left rectangle_2 rectangle_1_dark">
						<select class="text_align_center no_border button_1_text_dark" id="sel_housing">
					...
					<div class="left rectangle_2 rectangle_1_dark">
						<select class="text_align_center no_border button_1_text_dark" id='sel_group'>
					...
					<div class="right rectangle_2 rectangle_1_dark">
						<input type="text" value="Курс" class="text_align_center no_border button_1_text_dark" id="inp_cors">
					</div>
					<br><br><br>
					<div class="rectangle_2 rectangle_1_dark">
						<input type="text" value="ФИО" class="text_align_center no_border button_1_text_dark" id='inp_fio'>
					</div>
					<br>
				</div>
				<br>
				<div class="window_2 bg_color_1_dark">
					...
					<div class="left rectangle_2 rectangle_1_dark">
						<input type="text" value="Почта" class="text_align_center no_border button_1_text_dark" id='inp_mail'>
					</div>
					<div class="left rectangle_2 rectangle_1_dark">
						<input type="text" value="Телефон" class="text_align_center no_border button_1_text_dark" id='inp_tel'>
					</div>
					<div class="right rectangle_2 rectangle_1_dark">
						<label>Пароль</label>
						<input type="password" class="text_align_center no_border button_1_text_dark" id='inp_pass'>
					</div>
				</div>
				<br>
				<div class="window_2 bg_color_1_dark">
			...
			<?php
			$sel_housing = strip_tags($_GET['sel_housing'] ?? "");
			$sel_group = strip_tags($_GET['sel_group'] ?? "");
			$inp_cors = strip_tags($_GET['inp_cors'] ?? "");
			$inp_mail = strip_tags($_GET['inp_mail'] ?? "");
			$inp_tel = strip_tags($_GET['inp_tel'] ?? "");
			$inp_pass = strip_tags($_GET['inp_pass'] ?? "");

			$DB = Connect_DB();
			if ($sel_housing != "" && $sel_group != "" && $inp_cors != "" && $inp_mail != "" && $inp_tel != "" && $inp_pass != "")
			{
				$Result = Use_DB($DB, "INSERT INTO `Кураторы`(`ID_куратора`, `ID_корпуса`, `ФИО`, `Телефон`, `Электронная_почта`, `Пароль`, `Вопрос`, `Ответ`) VALUES ('');");
			}
			?>
